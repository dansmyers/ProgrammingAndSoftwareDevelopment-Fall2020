# CMS 121 &ndash; Programming and Software Development
...
We will use [Eclipse](https://www.eclipse.org/) for our programming assignments and lab activities. Eclipse is the industry standard **integrated development environment** (IDE) for Java.
...
| -------------|---------------------------------|--------|--------|-----------------|
| 1            | Java fundamentals: printing, variables, types, input, conditionals | 9/14     | 9/30       | Get Back Into Shape with Java! |
| 2            | Loops and arrays         |  9/30    |  10/14     | Problem Set |
| 3            | Methods and recursion      |   10/14   |  10/28      | Notakto  |
| 4            | Intro to objects and classes (feat. graphics)  | 10/28   |  11/11  | The Grandaddy of 'Em All |
| 5            | Files, ArrayLists, and HashMaps |   11/11  | 12/2   | Ye Olde Shakespearean Search Engine   |
| 6            | Distributed applications  |   12/2  |  12/18  | A Compleat Distributed Shakespearean Search Engine  |
